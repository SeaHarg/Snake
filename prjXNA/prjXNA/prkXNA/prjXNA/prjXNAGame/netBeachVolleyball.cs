...
{
    class netBeachVolleyball:theGame
    {
        sprite sand;
        ...
        public override void gameRender()
        {
            ...
            if (stage == 0)
            {
                state.draw(10, 10, Microsoft.Xna.Framework.Graphics.Color.Red);
                state1.draw(10, (int)(state.getHeight() + 10), Microsoft.Xna.Framework.Graphics.Color.Red);
                netState.draw(10, (int)(state1.getHeight() + state1.getHeight()), Microsoft.Xna.Framework.Graphics.Color.Red);
            }
            else if (stage == 3)//game stage
            {
                //draw everything
